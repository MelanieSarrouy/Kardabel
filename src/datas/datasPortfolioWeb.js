...
export const datasPortfolioWeb = [
  ...
  },
  {
    ...
    technos: ['html', 'scc', 'animations css'],
    links: {
  ...
  },
  {
    title: 'SportSee',
    image: imgSportSee,
    description: 'Tableau de bord d\'analytics pour la page utilisateur d\'une application de coaching sportif',
    work: "Création et affichage de graphiques avec Recharts. Récupération des données utilisateurs grâce à une API",
    technos: ['react', 'recharts', 'styled-components'],
    links: {
  ...
  },
  {
    ...
    technos: ['react', 'redux', 'styled-components'],
    links: {
      site: '',
  ...
  },
  {
    ...
    technos: ['react', 'redux', 'styled-components', 'firestore'],
    links: {
  ...
  },
  {
    title: 'Kardabel',
    image: imgKardabel,
    description: 'Site vitrine, services print et web, identité visuelle, design graphique, développement d\'applications et de sites internets',
  ...
  },
  {
    ...
    description: 'Site vitrine pour une association d\'éleveuses et d\'éleveurs proposant l\'abattage à la ferme',
    work: "Création d'un site WordPress, adaptation de la charte graphique au site",
    technos: ['WordPress', 'OceanWP', 'Elementor'],
    links: {
